					...
					<div class="row">	
						...
						<div class="col-md-6 col-lg-3">
							<div class="footer-info mb-40">
								...
								<img src="{{ asset('images/image/logoeng.png') }}" width="180" height="60" alt="footer-logo">
						...
						<div class="col-md-6 col-lg-3">
							<div class="footer-box mb-40">
								...
								<!-- Email -->
								<p class="foo-email mt-20">E: <a href="mailto:info@cure-hospital.com">info@cure-hospital.com</a></p>

								<!-- Phone -->
								<p>P:02 22872012 – 02 22872013</p>
								<p>P:010 - 27027070</p>
							</div>
						</div>	
